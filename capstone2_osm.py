...
Original file is located at
    https://colab.research.google.com/drive/1LN_fGHJgLQsHIqfRD9IGHflk-oBaRY-G
"""
...
# history = model.fit(trainX, trainY, epochs=2000, batch_size=16, validation_split=0.1, verbose=1)
# history = model.fit(trainX, trainY, epochs=2000, batch_size=32, validation_split=0.1, verbose=1)
# history = model.fit(trainX, trainY, epochs=2000, batch_size=64, validation_split=0.1, verbose=1)
# history = model.fit(trainX, trainY, epochs=4000, batch_size=16, validation_split=0.1, verbose=1)
history = model.fit(trainX, trainY, epochs=4000, batch_size=32, validation_split=0.1, verbose=1)
# history = model.fit(trainX, trainY, epochs=4000, batch_size=64, validation_split=0.1, verbose=1)
# history = model.fit(trainX, trainY, epochs=1000, batch_size=16, validation_split=0.1, verbose=1)
# history = model.fit(trainX, trainY, epochs=1000, batch_size=32, validation_split=0.1, verbose=1)
